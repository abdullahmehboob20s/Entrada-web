...
function TravelingAreaCard() {
  return (
    <div className="border-[1px] -border-gray rounded-2xl py-5 px-5 flex space-x-6">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="mb-8 flex">
          <div className="w-[70%]">
            <h2 className="text-lg 2xl:text-xl font-bold -text-blue-300 mb-4">
              A secret river adventures tour. Explore the nature wonders of the
              Riviera Maya
            </h2>

            <p className="text-sm 2xl:text-base -text-gray leading-[1.6]">
        ...
        <div className="flex items-center justify-between">
          <div className="flex space-x-8">
            <div>
              <p className="text-xs mb-1 leading-[1] font-bold">Offered By</p>
              <p className="text-sm font-bold">Hiking Njeriy</p>
            </div>
            <div>
              <p className="text-xs mb-1 leading-[1] font-bold">Duration</p>
              <p className="text-sm font-bold">11 Hours</p>
            </div>
          </div>
          <div className="space-y-1">
            <div className="flex items-center justify-end space-x-2">
              <MdDone className="-text-gray text-xl" />
              <p className="text-xs text-right  -text-gray font-normal">
                Free Cancellation
              </p>
            </div>
            <div className="flex items-center justify-end space-x-2">
